...
namespace EmployeeDirectoryWebApplication.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, int? pageNumber)
        {
            ...
            var departments = _context.Department.AsNoTracking();
            ...
            var model = await PaginatedList<Department>.CreateAsync(departments, pageNumber 
                ?? 1, pageSize);

            if (Request.Headers["X-Requested-With"] == "XMLHttpRequest")
            {
                return PartialView("_DepartmentsTablePartial", model);
            }
